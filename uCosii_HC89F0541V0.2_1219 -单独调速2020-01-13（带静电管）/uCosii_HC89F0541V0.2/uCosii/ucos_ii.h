...
OS_EXT  idata OS_TCB           *OSTCBHighRdy;                    /* Pointer to highest priority TCB R-to-R   */
...
OS_EVENT     *OSMboxCreate            (void            *pmsg) reentrant;
...
INT8U         OSMboxQuery             (OS_EVENT        *pevent,
                                       OS_MBOX_DATA    *p_mbox_data) reentrant;
#endif
#endif
...
INT8U         OSMemQuery              (OS_MEM          *pmem,
                                       OS_MEM_DATA     *p_mem_data) reentrant;
#endif
...
INT8U         OSMutexQuery            (OS_EVENT        *pevent,
                                       OS_MUTEX_DATA   *p_mutex_data) reentrant;
#endif
...
INT8U         OSSemQuery              (OS_EVENT        *pevent,
                                       OS_SEM_DATA     *p_sem_data) reentrant;
#endif
...
INT8U         OSTaskChangePrio        (INT8U            oldprio,
                                       INT8U            newprio) reentrant; 
#endif

#if OS_TASK_CREATE_EN > 0u
INT8U         OSTaskCreate            (void           (*task)(void *p_arg) reentrant,
                                       void            *p_arg,
                                       OS_STK          *ptos,
...
#if OS_TASK_CREATE_EXT_EN > 0u
INT8U         OSTaskCreateExt         (void           (*task)(void *p_arg) reentrant,
                                       void            *p_arg,
                                       OS_STK          *ptos,
                                       INT8U            prio,
                                       INT16U           id,
...
INT8U         OSTaskStkChk            (INT8U            prio,
                                       OS_STK_DATA     *p_stk_data) reentrant;
#endif

#if OS_TASK_QUERY_EN > 0u
INT8U         OSTaskQuery             (INT8U            prio,
                                       OS_TCB          *p_task_data) reentrant;
#endif
...
void          OSTimeDly               (INT32U           ticks) reentrant;
...
#ifdef OS_SAFETY_CRITICAL_IEC61508
void          OSSafetyCriticalStart   (void) reentrant;
#endif
...
INT8U         OS_EventTaskRdy         (OS_EVENT        *pevent,
                                       void            *pmsg,
                                       INT8U            msk,
                                       INT8U            pend_stat) reentrant;

void          OS_EventTaskWait        (OS_EVENT        *pevent) reentrant;

void          OS_EventTaskRemove      (OS_TCB          *ptcb,
                                       OS_EVENT        *pevent) reentrant;

#if (OS_EVENT_MULTI_EN > 0u)
void          OS_EventTaskWaitMulti   (OS_EVENT       **pevents_wait) reentrant;

void          OS_EventTaskRemoveMulti (OS_TCB          *ptcb,
                                       OS_EVENT       **pevents_multi) reentrant;
#endif
...
void          OS_TaskReturn           (void) reentrant; 
#endif
...
void          App_TaskCreateHook      (OS_TCB          *ptcb) reentrant;
void          App_TaskDelHook         (OS_TCB          *ptcb) reentrant;
void          App_TaskIdleHook        (void) reentrant;

void          App_TaskReturnHook      (OS_TCB          *ptcb) reentrant;

void          App_TaskStatHook        (void) reentrant;

#if OS_TASK_SW_HOOK_EN > 0u
void          App_TaskSwHook          (void) reentrant;
#endif

void          App_TCBInitHook         (OS_TCB          *ptcb) reentrant;
